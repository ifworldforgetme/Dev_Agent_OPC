...
6. For customer-facing UI, finish the planned UI batch before visual scoring, then invoke `frontend-ui-engineering` and run `bin/dev-flow qa-check <project-name>`.
