---
description: Invoke a Dev Agent OPC specialist role/persona
---
...
Use one role for one perspective and one output. Personas do not call other personas; use `/ship` for release fan-out and merge.
