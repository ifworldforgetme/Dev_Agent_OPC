...
5. Do not use sketches or prototypes as build inputs. Satisfy `dev-agent/references/design-artifacts.md` when formal visual assets or HTML/CSS design packages are needed.
