...
1. Run or confirm `bin/dev-flow design-check <project-name>` before UI code; return to design if screen acceptance or required formal assets/packages are missing.
...
If no design contract exists, or required formal artifact/package contracts are missing, return to the design phase first.
