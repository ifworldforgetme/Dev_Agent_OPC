...
2. Write or update `work/<project-name>/product/PRD.md` with MVP scope, core stories, acceptance criteria, metrics only when useful, and explicit non-goals.
3. Write `work/<project-name>/specs/SPEC.md` with stack constraints, host needs, source boundaries, commands, code style, test strategy, risks, and success criteria.
