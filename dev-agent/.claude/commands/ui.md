...
1. Run or confirm `bin/dev-flow design-check <project-name>` before UI code; return to design/plan if the formal design contract is missing.
2. Read design artifacts, approved assets, HTML companions when applicable, Figma handoff when used, cut assets, and `tasks/IMPLEMENTATION_TRACE.md`.
