# Dev Agent Skill Anatomy

This document describes the structure and format of Dev Agent workflow skill
files. Use it when adding or reshaping skills under `skills/<name>/SKILL.md`.
...
- References: stored in `references/` at the runtime source root, not inside skill directories
