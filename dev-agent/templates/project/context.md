...
- QA: optional unless `AUTOMATED_QA` or `VISUAL_QA` is required; run after the overall requested implementation is complete or when the user asks. Read verification, functional/monkey logs, visual comparison, and exception screenshots only when needed.
